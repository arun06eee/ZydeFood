			...
			<div class="tab-content">
				<div id="general" class="tab-pane row wrap-all active">
					<div class="form-group">
						<label for="input-name" class="col-sm-3 control-label"><?php echo lang('column_name'); ?></label>
						<div class="col-sm-5">
					...
					<div class="form-group">
						<label for="input-name" class="col-sm-3 control-label"><?php echo lang('column_percentage'); ?></label>
						<div class="col-sm-5">
							<input type="text" name="percentage" id="input-percentage" class="form-control" value="<?php echo set_value('percentage', $percentage); ?>" />
							<?php echo form_error('percentage', '<span class="text-danger">', '</span>'); ?>
						</div>
					</div>
					
					<div class="form-group">
						<label for="input-status" class="col-sm-3 control-label"><?php echo lang('column_status'); ?></label>
						<div class="col-sm-5">
