...
$config['extension_meta'] = array(
	...
	'title'       => 'PayUMoney',
	'author'      => 'Arun kumar',
	'description' => 'This extension will allow you to accept PayUMoney payment method during checkout.',
	'settings'    => TRUE,
);
...
$config['extension_permission'] = array(
	'name'        => 'Payment.PayUMoney',
	'action'      => array('manage'),
	'description' => 'Ability to manage PayUMoney payment',
);